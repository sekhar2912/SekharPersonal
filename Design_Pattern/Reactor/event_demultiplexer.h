...
namespace reactor
{
    ...
    public:
        ...
        virtual int RequestEvent(handle_t handle, event_t evt, reactor::Message *m_message = nullptr) = 0;
    ...
    public:
        ...
        virtual int RequestEvent(handle_t handle, event_t evt, reactor::Message *m_message);
