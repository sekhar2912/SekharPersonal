...
public:
    ...
    virtual void OnMessage(const reactor::Message* msg) override
    {
       m_message = msg;
    }
...
private:
    ...
    const reactor::Message* m_message{ nullptr };
};
...
int main(int argc, char ** argv)
{
    ...
    reactor::Message message1 = { reactor::kReadEvent, {0,1} };
    msg_ptr = &message1;
    TimeClient client;
    ...
    client.OnMessage(msg_ptr);
    strncpy(g_write_buffer, msg_ptr->data, sizeof(msg_ptr->data));
    
    if (msg_ptr->type == reactor::kReadEvent)
    {

        g_reactor.RegisterHandler(&client, reactor::kWriteEvent, msg_ptr);
