...
namespace reactor
{
    ...
    int Reactor::RegisterHandler(EventHandler * handler, event_t evt,reactor::Message* m_message )
    {
        return m_reactor_impl->RegisterHandler(handler, evt,m_message);
    }
    ...
    int ReactorImplementation::RegisterHandler(EventHandler * handler, event_t evt,reactor::Message* m_message)
    {
        ...
        handler->OnMessage(m_message);
        return m_demultiplexer->RequestEvent(handle, evt,m_message);
    }
